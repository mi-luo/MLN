...
parser.add_argument('--model-path', type=str, default="/data1/wanglu/train/nohaze/exp114/weights/best.pt", help='Path to the model')
#parser.add_argument('--img-path', type=str, default='data/images', help='input image path')
parser.add_argument('--img-path', type=str, default='/data1/wanglu/datasets/insulator_haze_oneclass/nohaze/val_gradcam', help='input image path')
parser.add_argument('--output-dir', type=str, default='/data1/wanglu/datasets/insulator_haze_oneclass/nohaze/val_gradcam_output/', help='output dir')
