...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        #out = model(im) if training else model(im, augment=augment, val=True)
        dt[1] += time_sync() - t2
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/defect_insulator/defect1anddefect2twoclass.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/data1/wanglu/train/defect1/exp11/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='/data1/wanglu/val/defect1', help='save to project/name')
