...
if __name__ == '__main__':
    import random
    # 给出图片文件夹和检测框文件夹所在的位置
    image_dir = '/data1/wanglu/datasets/plad/pladtogather481/VOC2007/JPEGImages/'
    annotation_dir = '/data1/wanglu/datasets/plad/pladtogather481/VOC2007/Annotations/'

    image_list = []  # 存放每张图像和该图像对应的检测框坐标信息

    # os.listdir(image_dir)

    # file_list =  os.listdir(r'C:\Users\Admin\Desktop\所有小论文\王露小论文1\2305')
    # print(file_list)
    # print(111111111111111)
    ori_image_list = os.listdir(image_dir)
    ...
    for i in range(4):
        ...
        print(random.choices(ori_image_list))
        print(type(random.choices(ori_image_list)))
        img_name = random.choices(ori_image_list)[0]
        ...
        annotation_path = annotation_dir + img_name.replace('jpg', 'xml')
