...
if __name__ == "__main__":
    train_list,val_list = split_data("/data1/wanglu/datasets/ttpla_data_original_size_v1/data_original_size/image",0.8)
    writ_save(train_list, "/data1/wanglu/datasets/ttpla_data_original_size_v1/data_original_size/ImageSets/train.txt")
    writ_save(val_list, "/data1/wanglu/datasets/ttpla_data_original_size_v1/data_original_size/ImageSets/val.txt")
